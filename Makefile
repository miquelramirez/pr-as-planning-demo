...
# Generated by qmake (2.01a) (Qt 4.7.0) on: jue may 17 00:29:43 2012
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib -L/home/bowman/Sandboxes/aptk/toolkit -laig -lQtXml -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
SOURCES       = main.cxx \
		...
		model/Drop.cxx \
		model/PickUp.cxx \
		planning/PlanningThread.cxx moc_SimHomeConfig.cpp \
		moc_SimHome.cpp \
		moc_AppWindow.cpp \
		moc_Home.cpp \
		moc_Room.cpp \
...
Makefile: sim-home.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/g++.conf \
		/usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/qconfig.pri \
		/usr/share/qt4/mkspecs/modules/qt_webkit_version.pri \
